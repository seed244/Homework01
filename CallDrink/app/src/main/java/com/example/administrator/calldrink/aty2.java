package com.example.administrator.calldrink;
...
public class aty2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioGroup rg1 = (RadioGroup) findViewById(R.id.radipGroup1);
        ...
        RadioGroup rg = (RadioGroup) findViewById(R.id.radipGroup);
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkld) {
                switch (checkld) {
